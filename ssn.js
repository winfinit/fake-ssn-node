...
var createSSN = (function () {
    function ssn(state) {
        ...
        this.ssn = this.generate(state);
    };
    
    // this will generate ssn
    createSSN.prototype.generate = function (state) {
        ...
        var generatedSSN = "" + area + group + randomLastFour;
        return generatedSSN;
    };
    
    createSSN.prototype.toFormattedString = function () {
        return this.ssn.substr(0, 3) + "-" + this.ssn.substr(3, 2) + "-" + this.ssn.substr(5, 4);
    };
    
    createSSN.prototype.toString = function () {
        return this.ssn;
    };
    
    return createSSN;
}());
exports.createSSN = createSSN;
